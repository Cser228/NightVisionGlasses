package net.java.nvgmod.armor_materials;
...
public class NVGArmorMaterial {
    public static final DeferredRegister<ArmorMaterial> ARMOR_MATERIALS
            = DeferredRegister.create(Registries.ARMOR_MATERIAL, NVGMod.MOD_ID);

    public static final Holder<ArmorMaterial> NVG_MATERIAL =
            ARMOR_MATERIALS.register("nvg_material", () -> new ArmorMaterial(
                    ...
                    List.of(
                            ...
                            new ArmorMaterial.Layer(
                                    ResourceLocation.fromNamespaceAndPath(NVGMod.MOD_ID, "nvg_material")
                            ),
                            ...
                            new ArmorMaterial.Layer(
                                    ResourceLocation.fromNamespaceAndPath(NVGMod.MOD_ID, "nvg_material"), "_overlay", true
                            )
                    ),
